...
import { apiGet, apiPut } from "@/hooks/use-api";
...
export default function SettingsPage() {
  ...
  const updateProfileMutation = useMutation({
    mutationFn: (data: ProfileFormValues) => apiPut("/api/user", data),
    onSuccess: () => {
  ...
  const updatePasswordMutation = useMutation({
    mutationFn: (data: PasswordFormValues) => apiPut("/api/user/password", data),
    onSuccess: () => {
